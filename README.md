...
* pdf is not saved to directory because using <code>git add data/* img/*</code> will only save changes in these directories, using <code>git add --all</code> would save all changes (incl. the generated pdf)
